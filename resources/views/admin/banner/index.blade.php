            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h6 class="font-weight-normal mb-0">Data Banner</h6>
                </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex justify-content-between">
                    <h3><i class="mdi mdi-view-list"></i> List Data Banner</h3>
                      ...
                      <tbody>
                        ...
                        <tr class="odd selected">
                          ...
                          <td class="text-center">
                            <a href="/admin/banner/edit/{{$data->id}}"><button class="btn btn-inverse-success btn-sm"><i class="ti-pencil"> Edit</i></button></a>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-body">
                ...
                <div class="row mt-1">
                  <div class="col-md-6">
                    <a href="/admin/banner/delete/{{$data->id}}" style="text-decoration: none;">
