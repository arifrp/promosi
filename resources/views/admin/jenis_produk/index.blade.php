              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex justify-content-between">
                    <h3><i class="mdi mdi-view-list"></i> List Data Jenis Produk</h3>
                    <a href="/admin/jenis_produk/add">
                      ...
                      <tbody>
                        ...
                        <tr class="odd selected">
                          ...
                          <td class="text-center">
                            <a href="/admin/jenis_produk/edit/{{$data->id}}"><button class="btn btn-inverse-success btn-sm"><i class="ti-pencil"> Edit</i></button></a>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-body">
                ...
                <div class="row mt-1">
                  <div class="col-md-6">
                    <a href="/admin/jenis_produk/delete/{{$data->id}}" style="text-decoration: none;">
