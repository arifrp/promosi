              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex justify-content-between">
                    <h3><i class="ti-pencil"></i> Edit Data Client</h3>
                    <a href="/admin/satuan">
                      <button type="button" class="btn btn-inverse-info btn-rounded btn-sm"><i class="ti-arrow-left mr-1"></i> Back</button>
                    </a>
                  </div>
                  <hr>
                  <form class="forms-sample" action="/admin/client/update/{{$satuan->id}}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="form-group">
                      <label for="exampleInputUsername1">Judul</label>
                      <input type="text" autofocus required class="form-control" name="judul" placeholder="Masukan Judul Client..." value="{{$satuan->judul}}">
                    </div>
                    <div class="form-group">
