          ...
          <li class="nav-item @if ($activePage == 'master') active @endif">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="/admin/jenis_produk">Data Jenis Produk</a></li>
                <li class="nav-item"> <a class="nav-link" href="/admin/banner">Data Banner</a></li>
              </ul>
            </div>
          </li>
          @endif
